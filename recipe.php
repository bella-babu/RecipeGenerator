...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="2KL6JYQYH4I6REYMIWBYVUGXPI.jpg" alt="First slide" style="width:100% ; height: 550px;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="OIP.jpg" alt="Second slide" style="width:100% ; height: 550px;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="chicken-strips.png" alt="Third slide" style="width:100% ; height: 550px;">
            </div>
        </div>
    ...
    ?><style>
        ...
        <?php
        $rest = $_REQUEST['recipe'];
        $a = "select * from receipe where r_name='$rest'";
        $re = $conn->query($a);
        if ($re) {
            $fe = $re->fetch_object();
        ?><center><img align="center" src="<?php echo $fe->imagesrc; ?>" style="border:10px solid;" class="img-rounded" height="40%" width="40%">
                ...
                <figcaption align="center">
                    <h2 style="color:red;font-weight:bold;font-family:Kite one;"><?php echo $fe->r_name; ?></h2>
                </figcaption><br><br><br>
                ...
                <h3 style="color:blue;font-family:Fresca;"> <?php
                                                            ...
                                                            $str = $fe->STEPS; ?></h3>
                <h4 style="color:black;font-family:Salsa;"> <?php
                                                            echo wordwrap($str, 100, "<br>\n");


                                                            ?></h4><br><br><br>
                <h3 style="color:blue;font-family:Fresca;"> <?php
                                                            echo "SOURCE OF RECIPE";
                                                            echo "<br \>";
        ...
        ?>
            ...
            <caption>
                <h2 style="font-family: 'Rufina';font-style: normal;font-weight: 400;font-size: 50px;line-height: 84px;color: #DE448D;" align="center">Recipes Available</h2>
                <p align="center" style="color:black;font-size:20px;font-family:Verdana;">Recipes are listed below.<br>
                    Select a recipe and done!</p>
            </caption>
            <?php
            include('conn.php');
            $w = "select * from receipe";
            $res = $conn->query($w);
            if ($res) {
            ?><div class="help">
                    <table class="table" style="width: 30%;margin-left:35%;">
                        ...
                        <form method="POST" action=""><?php
                                                        ...
                                                        ?>
                                <tr>
                                    <td width="10%" align="right" style="background-image:url('https://wallpaperaccess.com/full/1526003.png')">
                                        <input type="radio" name="recipe" value="<?php echo $fe->r_name; ?>">
                                    </td>

                                    <td width="60%" style="color:white;font-size:20px;font-family:Perpetua;background-image:url('https://wallpaperaccess.com/full/1526003.png')"><?php echo $fe->r_name; ?></td>
                                </tr>
                            <?php
                                                        }
                            ?>
                            <tr>
                                <td align="center" colspan="2" style="color:red;font-size:20px;font-family:Perpetua;">
